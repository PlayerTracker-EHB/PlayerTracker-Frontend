      ...
      <div className="container px-6 py-8 mx-auto">
        <div className="xl:items-center xl:-mx-8 xl:flex">
          <div className="flex flex-col items-center xl:items-start xl:mx-8">
            ...
            <Link to="/about" className="flex items-center mt-4 -mx-1 text-sm text-gray-700 capitalize dark:text-teal-400 hover:underline hover:text-teal-600 dark:hover:text-teal-500">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-8 space-y-4">
                    <div className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-teal-500" viewBox="0 0 20 20" fill="currentColor">
